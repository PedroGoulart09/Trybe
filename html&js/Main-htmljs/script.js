...
function addClick() {
    ...
    for (let i = 0; i < 4; i++) {
        ...
        if (sexta[i].style.backgroundColor === 'black') {
            sexta[i].style.backgroundColor = 'transparent'
        } else {
            sexta[i].style.backgroundColor = 'black'
        }
    }
...
function mudaCor(cor) {
    ...
    create.style.backgroundColor = cor;
    myTasks.appendChild(create);
...
function pegaDiv() {
    ...
    pegaTask.addEventListener('click', function () {
        if (pegaTask.classList.contains('selected')) {
            pegaTask.classList.remove('selected');
        } else {
            pegaTask.classList.add('selected');
...
function input() {
    let pegaImput = document.getElementById('task-input');
    let pegaButton = document.getElementById('btn-add');
    let minhasTarefas = document.querySelector('.task-list');
    ...
    pegaButton.addEventListener('click', function () {
        ...
        criarTarefa.innerText = pegaImput.value;

        minhasTarefas.appendChild(criarTarefa);
        pegaImput.value = '';
    })
